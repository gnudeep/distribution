...
GRANT ALL ON WSO2AM_COMMON_DB.* TO 'DATABASE_USERNAME'@'%' IDENTIFIED BY 'DATABASE_PASSWORD';
GRANT ALL ON WSO2AM_APIMGT_DB.* TO 'DATABASE_USERNAME'@'%' IDENTIFIED BY 'DATABASE_PASSWORD';
GRANT ALL ON WSO2AM_STAT_DB.* TO 'DATABASE_USERNAME'@'%' IDENTIFIED BY 'DATABASE_PASSWORD';
...
CREATE INDEX IDX_IDN_SCIM_GROUP_TI_RN_AN ON IDN_SCIM_GROUP (TENANT_ID, ROLE_NAME, ATTR_NAME(100));
...
CREATE USER IF NOT EXISTS 'DATABASE_USERNAME'@'%' IDENTIFIED BY 'DATABASE_PASSWORD';
GRANT ALL ON SP_MGT_DB.* TO 'DATABASE_USERNAME'@'%' IDENTIFIED BY 'DATABASE_PASSWORD';
GRANT ALL ON SP_WORKER_STATE_DB.* TO 'DATABASE_USERNAME'@'%' IDENTIFIED BY 'DATABASE_PASSWORD';
GRANT ALL ON cepDB.* TO 'DATABASE_USERNAME'@'%' IDENTIFIED BY 'DATABASE_PASSWORD';
GRANT ALL ON spDB.* TO 'DATABASE_USERNAME'@'%' IDENTIFIED BY 'DATABASE_PASSWORD';

GRANT ALL ON HTTP_ANALYTICS_DB.* TO 'DATABASE_USERNAME'@'%' IDENTIFIED BY 'DATABASE_PASSWORD';
GRANT ALL ON MESSAGE_TRACING_DB.* TO 'DATABASE_USERNAME'@'%' IDENTIFIED BY 'DATABASE_PASSWORD';
GRANT ALL ON WSO2AM_MGW_ANALYTICS_DB.* TO 'DATABASE_USERNAME'@'%' IDENTIFIED BY 'DATABASE_PASSWORD';
GRANT ALL ON WSO2AM_STATS_DB.* TO 'DATABASE_USERNAME'@'%' IDENTIFIED BY 'DATABASE_PASSWORD';
GRANT ALL ON CELLERY_OBSERVABILITY_DB.* TO 'DATABASE_USERNAME'@'%' IDENTIFIED BY 'DATABASE_PASSWORD';
...
DROP DATABASE IF EXISTS WSO2IDP_COMMON_DB;
DROP DATABASE IF EXISTS WSO2IDP_IDENTITY_DB;
DROP DATABASE IF EXISTS WSO2IDP_CONSENT_DB;

CREATE DATABASE WSO2IDP_COMMON_DB;
CREATE DATABASE WSO2IDP_IDENTITY_DB CHARACTER SET latin1;
CREATE DATABASE WSO2IDP_CONSENT_DB CHARACTER SET latin1;

GRANT ALL ON WSO2IDP_COMMON_DB.* TO 'DATABASE_USERNAME'@'%' IDENTIFIED BY 'DATABASE_PASSWORD';
GRANT ALL ON WSO2IDP_IDENTITY_DB.* TO 'DATABASE_USERNAME'@'%' IDENTIFIED BY 'DATABASE_PASSWORD';
GRANT ALL ON WSO2IDP_CONSENT_DB.* TO 'DATABASE_USERNAME'@'%' IDENTIFIED BY 'DATABASE_PASSWORD';

USE WSO2IDP_COMMON_DB;
